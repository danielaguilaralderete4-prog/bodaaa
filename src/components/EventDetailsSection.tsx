    ...
    <section id="event" className="py-20 sm:py-28 px-4 sm:px-6 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col items-center text-center max-w-2xl mx-auto mb-16">
        ...
        <h2 className="font-serif-display text-3xl sm:text-4xl text-[#333333] font-semibold mb-4">
          La Celebración de Nuestra Unión
        </h2>
      ...
      <div className="max-w-2xl mx-auto">
          <div className="bg-[#FDFCF0] border border-[#E0D8C3] rounded-3xl p-6 sm:p-8 relative shadow-sm">
            ...
            <div className="text-center mb-6">
              ...
              <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#EAE7DC] text-[#5A5A40] rounded-full text-xs font-semibold mt-3">
            ...
            <div className="w-full aspect-[16/10] rounded-2xl overflow-hidden border border-[#E0D8C3] mb-6 shadow-inner relative group">
              <img
                src={eventMapImage}
                alt="Mapa Centro eventos Matri Osorno - Ruta 215 y Ruta U-421"
            ...
            <a
              ...
              className="w-full inline-flex items-center justify-center gap-2 bg-[#5A5A40] hover:bg-[#474732] text-white font-medium text-xs uppercase tracking-[0.15em] py-3.5 px-6 rounded-full transition-all shadow-sm hover:shadow-md mb-4"
            >
            ...
            <div className="grid grid-cols-2 gap-2 pt-2 border-t border-[#E0D8C3]">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-1.5 text-xs text-[#5A5A40] bg-[#F7F3E9] hover:bg-[#EAE7DC] py-2.5 px-3 rounded-full border border-[#E0D8C3] transition-colors font-medium"
              >
