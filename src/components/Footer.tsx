    ...
    <footer className="bg-[#E8DFCF] border-t border-[#D8C29A] py-14 px-4 sm:px-6 text-center text-[#536078]">
      <div className="max-w-4xl mx-auto flex flex-col items-center space-y-6">
        ...
        <div className="flex items-center gap-2 text-[#B89A62]">
          ...
          <h3 className="font-serif-display text-2xl sm:text-3xl font-bold text-[#18243D] tracking-widest uppercase">
            Bárbara & Daniel
          </h3>
          <Sparkles className="w-4 h-4" />
        </div>

        <p className="text-xs uppercase tracking-[0.25em] font-semibold text-[#536078]">
          12 de Diciembre, 2026 &bull; Centro eventos Matri, Osorno
        </p>

        {/* Quick Links */}
        <div className="flex flex-wrap justify-center gap-6 text-xs uppercase tracking-wider font-medium text-[#18243D]">
        ...
        <div className="flex flex-col items-center gap-1 text-xs text-[#536078] font-light">
          <p className="italic font-serif-display text-sm text-[#18243D]">
